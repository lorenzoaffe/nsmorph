...
# NEUTROSOPHIC EROSION

nser_image = ns_image.erosion(ns_kernel)

# PLOT OF THE IMAGES

plt.suptitle("Neutrosophic erosion (M=membership, I=indeterminacy, NM=non-membership)")
...
plt.subplot(4,3,7)
plt.imshow(nser_image.getM(), cmap='gray')
plt.xticks([])
plt.yticks([])
plt.title("erosion M")

plt.subplot(4,3,8)
plt.imshow(nser_image.getI(), cmap='gray')
plt.xticks([])
plt.yticks([])
plt.title("erosion I")

plt.subplot(4,3,9)
plt.imshow(nser_image.getNM(), cmap='gray')
plt.xticks([])
plt.yticks([])
plt.title("erosion NM")

plt.subplot(4,3,11)
plt.imshow(nser_image.getRepresentation(), cmap='gray')
plt.xticks([])
plt.yticks([])
plt.title("erosion")

plt.subplot(4,3,12)
plt.imshow(nser_image.getRepresentation(binary=True, limit_value=0.04), cmap='gray')
plt.xticks([])
plt.yticks([])
plt.title("binarized erosion")
